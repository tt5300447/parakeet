...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $Module_2 = intval($Module_2);
    $Module_3 = intval($Module_3);
    $sql = "INSERT INTO Etudiant (matricule, nom, prenom, note_module_1, note_module_2, note_module_3) VALUES ($Matricule,'" . $Nom . "','" . $Prenom . "', $Module_1, $Module_2, $Module_3)";
...
?>
                ...
                <form class="form-horizontal" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" name="prenom" type="data" placeholder="" />
                        </div>
                    </div>
                    <div class="form-group">
