...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $Module_2 = intval($Module_2);
    $Module_3 = intval($Module_3);
    $sql = "INSERT INTO Etudiant (matricule, nom, prenom,date_naissance, note_module_1, note_module_2, note_module_3) VALUES ($Matricule,'" . $Nom . "','" . $Prenom . "', $Module_1, $Module_2, $Module_3)";
