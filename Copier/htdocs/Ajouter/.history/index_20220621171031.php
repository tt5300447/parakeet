            ...
            <div class="col-md-9 personal-info">
                <div class="alert alert-info alert-dismissable">
                    <?php
                        ...
                        function ($Matricule) verifyMatricule{
                            if(strlen($Matricule)> 26 || strlen($Matricule) < 26){
                                return false;
                            }
                        ...
                        function ($module_1,$Module_2,$Module_3) verifyNoteModule{
                        }
